...
public class SecondController {
    ...
    @FXML private void initialize() {
        ...
        // Show string info received from main window, and the database contents.
        String display = "Received the string  " + db.getStringInfo() + " from main window.\n";
    ...
    @FXML protected void handleCloseButton(ActionEvent event) {
        // Pass an integer value back to the main window's controller via the database class
        MainController._db.setIntInfo(42);
